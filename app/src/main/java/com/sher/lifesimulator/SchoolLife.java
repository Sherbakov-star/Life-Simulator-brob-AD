...
//    String alert = getResources().getString(R.string.alert);//недостаточно средств
//    String scoroplat = getResources().getString(R.string.scoroplat);
//    String scoroplat2 = getResources().getString(R.string.scoroplat2);//Плата за аренду:8000
//    String scoroplat3 = getResources().getString(R.string.scoroplat3);
//    String scoroplat4 = getResources().getString(R.string.scoroplat4);
//    String scoroplat5 = getResources().getString(R.string.scoroplat5);
//    String kur1 = getResources().getString(R.string.kur1);
//    String biz1 =getResources().getString(R.string.biz1);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.school_life);

         //Creating an extended library configuration.
        YandexMetricaConfig config = YandexMetricaConfig.newConfigBuilder("77ee9160-304b-4c24-99d4-7e9cecfc7bd4").build();
    ...
    public String getString1() {
        ...
        vitamin1 = getResources().getString(R.string.vitamin1);
    ...
    private void init(){
        ...
        String palatka = getResources().getString(R.string.palatka);
        ...
        money1.setText(pref.getString(save_money, String.valueOf(100)));

        vozrast1 = findViewById(R.id.vozrast);
        vozrast1.setText(pref.getString(save_vozrast, String.valueOf(12)));
        ...
        apartment1.setText(pref.getString(save_apartment,palatka));
    ...
    public void endgame(){
        ...
        if (num1 <= 0){
            ...
            btnclose.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    dialog.dismiss();
                    Intent intent = new Intent(SchoolLife.this,GlavniyEcran.class);
   ...
   public void cvet(){
    ...
    public void vitamin(View v){
        ...
        if(c == 4) {
            ...
            int num1 = Integer.parseInt(stud.getText().toString());
            int num2 = Integer.parseInt(zdor.getText().toString());
            Toast.makeText(this,vitamin1, Toast.LENGTH_SHORT).show();
            int d = num1 - 5;
            stud.setText(Integer.toString(d));
            int g = num2 - 40;
            zdor.setText(Integer.toString(g));
    ...
    public void roliki(View v){
        ...
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_school_car1);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 1000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void samokat(View v){
        TextView t = (TextView)findViewById(R.id.car);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_school_car2);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 5000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void bike(View v){
        TextView t = (TextView)findViewById(R.id.car);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_school_car3);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 10000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void electrosamokat(View v){
        TextView t = (TextView)findViewById(R.id.car);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_school_car4);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 30000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void goldroliki(View v){
        TextView t = (TextView)findViewById(R.id.car);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_school_car5);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 100000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void machina(View v){
        TextView t = (TextView)findViewById(R.id.car);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_school_car6);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 300000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void vert(View v){
        TextView t = (TextView)findViewById(R.id.car);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_school_car7);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 10000000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void bigpalat(View v){
        TextView g = (TextView)findViewById(R.id.apartment);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_school_apart1);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 5000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void kompan(View v){
        TextView g = (TextView)findViewById(R.id.apartment);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_school_apart2);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 8000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void kvarkomuns(View v){
        TextView g = (TextView)findViewById(R.id.apartment);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_school_apart3);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 15000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void kompansvoi(View v){
        TextView g = (TextView)findViewById(R.id.apartment);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_school_apart4);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 50000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void kvark(View v){
        TextView g = (TextView)findViewById(R.id.apartment);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_school_apart5);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 3000000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void dom(View v){
        TextView g = (TextView)findViewById(R.id.apartment);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_school_apart6);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 10000000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void villa(View v){
        TextView g = (TextView)findViewById(R.id.apartment);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_school_apart7);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 100000000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);

...
public class OldLifeE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.old_life_e);
    ...
    private void init(){
        ...
        String pansik = getResources().getString(R.string.pansionat);
        ...
        money1.setText(pref.getString(save_money, String.valueOf(1000)));

        vozrast1 = findViewById(R.id.vozrast);
        vozrast1.setText(pref.getString(save_vozrast, String.valueOf(60)));
        ...
        apartment1.setText(pref.getString(save_apartment,pansik));
    ...
    public void endgame(){
        ...
        if (num1 <= 0){
            ...
            btnclose.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    dialog.dismiss();
                    Intent intent = new Intent(OldLifeE.this,GlavniyEcran.class);
   ...
   public void cvet(){
    ...
    public void roliki(View v){
        ...
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_o_car1);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 1000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void samokat(View v){
        TextView t = (TextView)findViewById(R.id.car);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_o_car2);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 5000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void bike(View v){
        TextView t = (TextView)findViewById(R.id.car);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_o_car3);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 10000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void electrosamokat(View v){
        TextView t = (TextView)findViewById(R.id.car);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_o_car4);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 30000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void goldroliki(View v){
        TextView t = (TextView)findViewById(R.id.car);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_o_car5);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 100000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void machina(View v){
        TextView t = (TextView)findViewById(R.id.car);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_o_car6);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 300000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void vert(View v){
        TextView t = (TextView)findViewById(R.id.car);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_o_car7);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 10000000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void bigpalat(View v){
        TextView g = (TextView)findViewById(R.id.apartment);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_o_apart1);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 5000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void kompan(View v){
        TextView g = (TextView)findViewById(R.id.apartment);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_o_apart2);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 8000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void kvarkomuns(View v){
        TextView g = (TextView)findViewById(R.id.apartment);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_o_apart3);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 15000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void kompansvoi(View v){
        TextView g = (TextView)findViewById(R.id.apartment);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_o_apart4);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 50000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void kvark(View v){
        TextView g = (TextView)findViewById(R.id.apartment);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_o_apart5);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 3000000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void dom(View v){
        TextView g = (TextView)findViewById(R.id.apartment);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_o_apart6);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 10000000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void villa(View v){
        TextView g = (TextView)findViewById(R.id.apartment);
        TextView work = (TextView)findViewById(R.id.money);
        String s = getResources().getString(R.string.t_o_apart7);
        int num4 = Integer.parseInt(work.getText().toString());
        if (num4 >= 100000000){
            if (vibro == 0){
                Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
